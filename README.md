...
- 7+years Machine Learning & Data Engineering (Python, Scala, Spark, ETL pipelines)
...
I analyse, design, build and maintain data and cloud infrastructure for clients, with a focus on Web3, analytics, and scalable backends (Python, SQL, AWS, Terraform, ETL, APIs).
